...
Route::get('/callwaitress', [HomeController::class, 'callwaitress'])->name('callwaitress');
...
Route::post('/edit/footer/process', [TemplateController::class, 'footer_edit_process'])->name('/edit/footer/process');
Route::get('/template/footer', [TemplateController::class, 'allfooterdata'])->name('/template/footer');

// 2- Manage Home Template
Route::post('/edit/home/title', [TemplateController::class, 'hometitle_edit_process'])->name('/edit/home/title');
Route::post('/edit/home/description', [TemplateController::class, 'homedescription_edit_process'])->name('/edit/home/description');
Route::post('/edit/home/storytitle', [TemplateController::class, 'homestorytitle_edit_process'])->name('/edit/home/storytitle');
Route::post('/edit/home/storyvideo', [TemplateController::class, 'homestoryvideo_edit_process'])->name('/edit/home/storyvideo');
Route::post('/edit/home/storydescription', [TemplateController::class, 'homestorydescription_edit_process'])->name('/edit/home/storydescription');
Route::get('/template/home', [TemplateController::class, 'allhomedata'])->name('/template/home');

// 3- Manage Contact Template
Route::post('/edit/contact/bigtitle', [TemplateController::class, 'contactbigtitle_edit_process'])->name('/edit/contact/bigtitle');
Route::post('/edit/contact/title', [TemplateController::class, 'contacttitle_edit_process'])->name('/edit/contact/title');
Route::post('/edit/contact/description', [TemplateController::class, 'contactdescription_edit_process'])->name('/edit/contact/description');
Route::post('/edit/contact/email', [TemplateController::class, 'contactemail_edit_process'])->name('/edit/contact/email');
Route::post('/edit/contact/address', [TemplateController::class, 'contactaddress_edit_process'])->name('/edit/contact/address');
Route::post('/edit/contact/phone', [TemplateController::class, 'contactphone_edit_process'])->name('/edit/contact/phone');
Route::post('/edit/contact/map', [TemplateController::class, 'contactmap_edit_process'])->name('/edit/contact/map');
Route::get('/template/contact', [TemplateController::class, 'allcontactdata'])->name('/template/contact');

// 4- Manage About Template
Route::post('/edit/about/bigtitle', [TemplateController::class, 'aboutbigtitle_edit_process'])->name('/edit/about/bigtitle');
Route::post('/edit/about/title', [TemplateController::class, 'abouttitle_edit_process'])->name('/edit/about/title');
Route::post('/edit/about/description', [TemplateController::class, 'aboutdescription_edit_process'])->name('/edit/about/description');
Route::post('/edit/about/img', [TemplateController::class, 'aboutimg_edit_process'])->name('/edit/about/img');
Route::post('/edit/about/video', [TemplateController::class, 'aboutvideo_edit_process'])->name('/edit/about/video');
Route::get('/template/about', [TemplateController::class, 'allaboutdata'])->name('/template/about');
