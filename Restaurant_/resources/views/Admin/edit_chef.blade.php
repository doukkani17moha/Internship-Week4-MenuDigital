                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/chef/process/'.$chef->id) }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{  $chef->chef_name }}" class="form-control" id="exampleInputName1">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Job Title</label>
                        <input type="text" name="job" value="{{  $chef->chef_job }}" class="form-control" id="exampleInputName1">
                      </div>                
                      <div class="form-group">
