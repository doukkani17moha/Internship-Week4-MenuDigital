...
@section('container')
    ...
    <div class="card-columns">
        ...
        <div class="card">
            <img class="card-img-top" src="{{ asset('assets/images/plats/' . $product->plat_img) }}"
            ...
            <div class="card-footer">
                ...
                @if ($usertype != 'Sub Admin')
                    <small class="text-muted"><a href="{{ asset('/menu/edit/' . $product->id) }}"
                            class="btn btn-primary">Edit</a> </small>
                @endif
                <a href="{{ route('plats.toggle-enable-disable', ['id' => $product->id, 'action' => $product->enable ? 'disable' : 'enable']) }}"
