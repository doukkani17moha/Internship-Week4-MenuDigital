                ...
                @if ($plantype === 'Premium' || Auth::user()->usertype === 'founder')
                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/orders/pending">Pending
                                        Orders</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/orders/processing">Processing
                                        Order</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/orders/completed">Complete
                                        Orders</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/orders/failed">Cancelled Order</a>
                                </li>
                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/template/home">Home</a></li>
                                <li class="nav-item"> <a class="nav-link" href="/template/about">About</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/template/contact">Contact</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="/template/footer">Footer</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item menu-items">
                    ...
                    <li class="nav-item menu-items">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="/order/location">Track Orders</a>
                                </li>
