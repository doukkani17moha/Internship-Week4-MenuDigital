        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/home/title/'. Auth::user()->restaurant)}}" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/home/description/'. Auth::user()->restaurant)}}" method="post"
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/home/storytitle/'. Auth::user()->restaurant)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/home/storydescription/'. Auth::user()->restaurant)}}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ asset('/edit/home/storyvideo/'. Auth::user()->restaurant)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
