...
<div class="mt-4">
    ...
    <x-input-error :messages="$errors->get('email')" class="mt-2" />
     ...
     <!-- Restaurant Name -->
     <div class="mt-4">
        <x-input-label for="restaurant" :value="__('Restaurant Name')" class="text-black" />
        <x-text-input id="restaurant" class="block mt-1 w-full text-black" type="text" name="restaurant" :value="old('restaurant')" required autofocus autocomplete="restaurant" />
        <x-input-error :messages="$errors->get('restaurant')" class="mt-2" />
    </div>
