    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke px-0">
                <h1> <a class="navbar-brand" href="{{ asset('/owner/'. Auth::user()->restaurant) }}">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item {{ Request::is('/') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ asset('/owner/'. Auth::user()->restaurant) }}">Home <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item {{ Request::is('about') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ asset('/owner/about/'. Auth::user()->restaurant) }}">About</a>
                        </li>
                        <li class="nav-item {{ Request::is('menu') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ asset('/owner/menu/'. Auth::user()->restaurant) }}">Menu</a>
                        </li>
                        <li class="nav-item {{ Request::is('contact') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ asset('/owner/contact/'. Auth::user()->restaurant) }}">Contact</a>
                        </li>
