...
class ChefController extends Controller
{
    ...
    public function chefs()
    {
       if (!Auth::user()) {
        ...
        $total_chefs = DB::table('chefs')->where('restaurant',$restaurant)->count();
        $fraction = $total_chefs % 3;
        $chefs = DB::table('chefs')->where('restaurant',$restaurant)->get();
        $fraction_chefs = DB::table('chefs')->latest()->where('restaurant',$restaurant)->get();
