...
class PlatController extends Controller
{
    ...
    public function food_menu()
    {
        ...
        $total_plats = DB::table('plats')->where('restaurant',$restaurant)->count();
        $fraction = $total_plats % 3;
        $plats = DB::table('plats')->where('restaurant',$restaurant)->get();
        $fraction_plats = DB::table('plats')->latest()->where('restaurant',$restaurant)->get();
