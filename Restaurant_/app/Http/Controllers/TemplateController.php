...
class TemplateController extends Controller
{
    ...
    public function allfooterdata() {
        ...
        $all_data = DB::table('template')->get();
    ...
    public function footer_edit_process(Request $req)
    {
        ...
        $update = DB::table('template')->where('id', 1)->update($data);
        ...
        return redirect()->route('/template/footer');
    }
     ...
     */
     ...
     public function contactbigtitle_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
         ...
         return redirect()->route('/template/contact');
     }

     public function contacttitle_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
     ...
     public function contactdescription_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
     ...
     public function contactaddress_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
     ...
     public function contactemail_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
     ...
     public function contactphone_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
     ...
     public function contactmap_edit_process(Request $req)
     {
         // Validate the form data
         $this->validate($req, [
      ...
      */
      public function aboutbigtitle_edit_process(Request $req)
      {
          // Validate the form data
          $this->validate($req, [
          ...
          return redirect()->route('/template/about');
      }

      public function abouttitle_edit_process(Request $req)
      {
          // Validate the form data
          $this->validate($req, [
      ...
      public function aboutdescription_edit_process(Request $req)
      {
          // Validate the form data
          $this->validate($req, [
      ...
      public function aboutimg_edit_process(Request $req)
      {
          // Validate the form data
          $this->validate($req, [
      ...
      public function aboutvideo_edit_process(Request $req)
      {
          // Validate the form data
          $this->validate($req, [
     ...
     */
    public function hometitle_edit_process(Request $req)
    {
        // Validate the form data
        $this->validate($req, [
    ...
    public function homedescription_edit_process(Request $req)
    {
        // Validate the form data
        $this->validate($req, [
    ...
    public function homestorytitle_edit_process(Request $req)
    {
        // Validate the form data
        $this->validate($req, [
    ...
    public function homestorydescription_edit_process(Request $req)
    {
        // Validate the form data
        $this->validate($req, [
    ...
    public function homestoryvideo_edit_process(Request $req)
    {
        // Validate the form data
        $this->validate($req, [
